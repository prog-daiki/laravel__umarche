                ...
                <div class="md:p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        <div class="container md:px-5 mx-auto">
                            ...
                            <div class="flex justify-end mb-4 mr-48">
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <tr>
                                ...
                                <button type="button" onclick="location.href='{{route('admin.owners.edit',['owner' => $owner -> id])}}'" class="text-white bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-blue-500 rounded ">
                                    編集
                                </button>
                                </td>
                                ...
                                @method('delete')
                                <td class="md:px-4 py-3 ">
                                <a href="#" data-id="{{ $owner->id }}" type="button" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">
                                    削除
                                </a>
                                </td>
                                </form>
